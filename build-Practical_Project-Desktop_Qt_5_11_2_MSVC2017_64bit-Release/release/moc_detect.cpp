...
#include "../../Practical_Project/detect.h"
...
QT_MOC_LITERAL(1, 7, 15), // "detectionSignal"
...
QT_MOC_LITERAL(5, 38, 4) // "Stop"
    ...
    "Detect\0detectionSignal\0\0process\0Start\0"
    "Stop"
};
...
void Detect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->detectionSignal(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Detect::detectionSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Detect::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Detect.data,
