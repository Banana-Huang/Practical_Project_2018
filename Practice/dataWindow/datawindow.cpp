    ...
    ui(new Ui::DataWindow)
{
    ...
    setPieChart(database->getSingleDayData(QDate(2019,5,22)));
    setBarChart(database->getSingleDayEachHourData(QDate(2019,5,22)));
...
void DataWindow::setPieChart(QMap<QString,int> pieData)
{
...
void DataWindow::setBarChart(QMap<QString,QMap<QString,int>> barData)
{
